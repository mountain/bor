...
build %s.og.png: convert %s.pdf
build %s.hg.png: resize-huge %s.og.png
build %s.lg.png: resize-large %s.og.png
build %s.nm.png: resize-normal %s.og.png
build %s.sm.png: resize-small %s.og.png
build %s.tn.png: resize-tiny %s.og.png
'''
